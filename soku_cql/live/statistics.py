...
from ..action_space import ACTION_SCHEMA, NEUTRAL_ACTION_ID, from_controller, action_catalog
...
class EvaluationStatistics:
    def __init__(self, config, model):
        ...
        self.metadata = {"schema": "cql_live_evaluation_joint432_v2", "action_schema": ACTION_SCHEMA,
                         ...
                         "device": str(model.device), "action_selection": "deterministic_argmax_q",
