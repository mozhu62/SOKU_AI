...
export function Evaluation({state}:{state:Row}){
  // 保留 PPO 的模型选择、局数/难度确认及双报告对比流程；CQL 不存在在线优化器恢复。
