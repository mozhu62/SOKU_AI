...
class TCNObservationWindow:
    ...
    def logits(self, model, device, timing=None, tcn_device=None, available=None):
        ...
        result = model._fuse(current, temporal, objects, available, return_spell=model.spell_enabled)
